										    ...
										    <div class="col-md-6">
										     <form action="useraccountController" method="post">
                                                        <div class="form-group">
															...
															<input type="text" name="firstname" class="form-control" value="${param.firstname}" required />
	
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Last Name</label>
                                                            
															<input type="text" name="lastname" class="form-control" value="${param.lastname }" required/>
	
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Email</label>
                                                            <input type="email" class="form-control" name="email" value="${param.useremail }" placeholder="" required>
                                                        </div> 
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                         ...
                                                         <button type="submit" onclick="checkUserExist()" class="btn btn-primary">Update User</button>
