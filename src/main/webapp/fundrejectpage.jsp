									...
									<div class="row align-items-center">
										<div class="col-md-12">
											<div class="page-header-title">
												<h5 class="m-b-10">Request Rejected</h5>
											</div>
											<ul class="breadcrumb">
												...
												<li class="breadcrumb-item"><a href="#!">Request Rejected</a></li>
											</ul>
										</div>
									</div>
								</div>
										...
										<div class="card-body">
										    ...
										    <div class="col-md-6">
										     <form action="dashboardController" method="post">
                                                        ...
                                                        <input type="hidden" name="form" value="fundrejectoperation"/> 
